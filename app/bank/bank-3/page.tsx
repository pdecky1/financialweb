...
[
  {
    desc: 'Real exchange rates.'
  },
  {
    desc: 'Swap currencies in one click.'
  },
  {
    desc: 'Easy worldwide payments from wherever you are.'
  },
  {
    desc: 'Custody and sending of money in more than 40 currencies.'
  },
  {
    desc: 'Forex of FIAT'
  },
    ...
    <>
      ...
      <div className=' w-full h-full bg-[#F6F6F6] '>
        <div className=' container mx-auto flex flex-col justify-center items-center py-10 gap-y-4 '>
          <h1 className=' text-[#505050] font-semibold text-4xl italic mx-5 text-center'>FIAT Currencies Exchange</h1>
          <p className=' text-[#505050] text-center mx-5'>From our multi currencies bank account clients can instantly convert one of their FIAT balances in over 40 currencies to easily pay worldwide directly from the online banking.</p>
        </div>
      </div>
